...
main = do
  ...
  case args of
    ["help"]  -> do printHelpAndDie ""
    _         -> do checksOnProgram "./enigma"
                    checksOnDirectory
                    runTests "./enigma"
...
printHelpAndDie msg = do
  putStrLn . unlines $ 
    [ "Usage: ./tests"
    , "  ensure that you run the testsuite in the repo's root directory"
    , "  and that your compiled program is called enigma"
    , msg
    ] 
...
checksOnDirectory = do
  ...
  unless d1 $ printHelpAndDie "rotors directory does not exist"
  d2 <- doesDirectoryExist "./plugboards"
  unless d2 $ printHelpAndDie "plugboards directory does not exist"
...
theBasicTests = concatMap mkReverses $
  ...
  , ("AAAAAAAAAAAAAAAAAAAAAAAAAA", ["rotors/II.rot", "plugboards/null.pb"], "PLPLPLPLPLPLPLPLPLPLPLPLPL")
  , ("AAAAAAAAAAAAAAAAAAAAAAAAAA", ["rotors/III.rot", "plugboards/null.pb"], "LLFORJEVOKWPPKRFJMGQVJMQUR")
  , ("AAAAAAAAAAAAAAAAAAAAAAAAAA", ["rotors/IV.rot", "plugboards/null.pb"], "XPJHVOSIFNTRIVDSLXDMSXNDIF")
  , ("AAAAAAAAAAAAAAAAAAAAAAAAAA", ["rotors/V.rot", "plugboards/null.pb"], "HWCCYYHTKPFBZTHVJCQYCTYELR")
